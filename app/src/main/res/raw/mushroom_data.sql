...
INSERT INTO mushroom_info (name, name_pl, description, is_edible) VALUES
('Amanita rubescens', 'Muchomor czerwieniejący', 'Trzon cylindryczny, u podstawy bulwiasty, powierzchnia gładka lub kosmkowata, z wyraźnym, białym i prążkowanym pierścieniem. Miąższ biały, po przekrojeniu czerwieniejący, o słabym zapachu i słodkawym smaku. Owocnikuje w lasach liściastych i mieszanych.', 'tak');

INSERT INTO mushroom_info (name, name_pl, description, is_edible) VALUES
('Boletus fibrillosus', 'Borowik klinowotrzonowy', 'Kapelusz do 170 mm szerokości, barwy od beżowej do ciemnobrązowej, o pomarszczonej lub drobnowłóknistej teksturze. Rurki żółte, miąższ biały do ochrowego, nie zmienia barwy po przekrojeniu. Trzon żółtawy u góry, brązowy u podstawy, z siateczkowaniem.', 'tak');

INSERT INTO mushroom_info (name, name_pl, description, is_edible) VALUES
('Cantharellus formosus', '–', 'Kapelusz średniej wielkości, żółtawo-pomarańczowy do łososiowego, z wiekiem z brązowawymi tonami. Fałszywe blaszki wybrzuszone, zbiegające, często z różowawym odcieniem; trzon smukły, miąższ o przyjemnym owocowym zapachu. Występuje pod iglakami od jesieni do zimy.', 'tak');

INSERT INTO mushroom_info (name, name_pl, description, is_edible) VALUES
('Lactarius torminosus', 'Mleczaj wełnianka', 'Kapelusz 3–8 cm, biały z włóknistymi strefami, owłosiony; blaszki zbiegające, mleczko białe, o paląco ostrym smaku; rośnie w lasach liściastych i iglastych od lata do jesieni.', 'nie');
...
INSERT INTO mushroom_info (name, name_pl, description, is_edible) VALUES
('Neoboletus erythropus', 'Borowik ceglastopory', 'Kapelusz 5–15 cm, od beżowego do ciemnobrązowego; rury żółte w młodości, szybko ceglastopomarańczowe i siniejące po uszkodzeniu; trzon żółty z czerwonymi kropkami; rośnie pod świerkami na kwaśnych glebach.', 'tak');
...
INSERT INTO mushroom_info (name, name_pl, description, is_edible) VALUES
('Lactarius controversus', '–', 'Kapelusz 4–12 cm szarawy, z wgłębieniem i żeberkami na brzegu; blaszki zbiegające, kremowe; mleczko białe, łagodne, nie zmienia barwy; występuje pod brzozą i dębem.', 'tak');
...
INSERT INTO mushroom_info (name, name_pl, description, is_edible) VALUES
('Lactarius glyciosmus', 'Mleczaj kokosowy', 'Kapelusz 2–7 cm szer., szary lawendowy, gęste, zbiegające blaszki. Mleczko białe o zapachu kokosa, mykoryzuje z brzozą.', 'tak');

INSERT INTO mushroom_info (name, name_pl, description, is_edible) VALUES
('Pseudoboletus parasiticus', 'Borowik pasożytniczy', 'Kapelusz do 6 cm, żółtobrązowy. Trzon 3–7 cm wysoki; rośnie na guzowcach Scleroderma citrinum.', 'nie');
...
INSERT INTO mushroom_info (name, name_pl, description, is_edible) VALUES
('Russula nigricans', 'Gołąbek czarniawy', 'Kapelusz 5–15 cm, biały z wiekiem brunatniejący do czarnego; blaszki białe, z czasem ciemniejące; trzon biały, stary ciemnobieżny; występuje w lasach liściastych.', 'tak');
...
INSERT INTO mushroom_info (name, name_pl, description, is_edible) VALUES
('Cortinarius praestans', 'Zasłonak wystawny', 'Kapelusz 5–13 cm, brązowy, włóknisty; blaszki najpierw ochrowe, potem ciemnobrązowe; trzon masywny, pokryty delikatną zasnówką; występuje w lasach liściastych i mieszanych.', 'tak');
...
('Lactarius resimus', 'Biały grzyb mleczny', 'Kapelusz początkowo płasko wypukły, później lejkowaty o średnicy do 18-20 cm. Powierzchnia gładka, lekko wilgotna, mleczno-biała, czasem z żółtawym odcieniem. Miąższ dość zwarty, biały, o przyjemnym owocowym aromacie. Blaszki gęste, bladożółte. Zwykle występuje w grupach. Znany także jako surowy, mokry lub pravsky grzyb mleczny.', 'tak'),
...
('Suillus americanus', 'Maślak amerykański', 'Brak informacji w dostępnych wynikach wyszukiwania.', 'nieznane');
...
('Boletus aereus', 'Borowik brązowy', 'Boletus aereus, znany jako borowik brązowy, to ceniony grzyb jadalny z rodziny borowikowatych. Charakteryzuje się dużym, ciemnobrązowym do czarnobrązowego kapeluszem o średnicy 5-25 cm, początkowo półkulistym, później wypukłym. Powierzchnia kapelusza jest sucha, czasem delikatnie zamszowa. Rurki pod kapeluszem są białawe, później żółtozielone i nie sinieją po uszkodzeniu. Trzon jest pękaty, brązowy, z delikatną siateczką w górnej części. Miąższ biały, nie zmienia barwy po przekrojeniu. Występuje głównie w lasach liściastych, szczególnie pod dębami i bukami, preferując cieplejsze regiony. Jest uważany za jeden z najlepszych grzybów jadalnych w Europie.', 'tak'),
('Cortinarius camphoratus', 'Zasłonak odrażający', 'Grzyb z intensywnymi fioletowymi blaszkami, o zdecydowanie jaśniejszym kapeluszu i trzonie. Jest oślizły w dotyku i specyficznie cuchnący, stąd nazwa. Gatunek rzadki.', 'nie'),
